...
export default function Scroll(props) {
  ...
  const companies = [
    {Name: 'Sri K.P Babu', Executed: '15', Shortfall: '5'},
    {Name: 'IT Mall', Executed: '10', Shortfall: '10'},
  ];
          ...
          <View style={styles.common}>
            <View style={styles.trow1}>
              ...
              <View
                ...
                <Text style={styles.ttext}>Executed</Text>
              </View>
              <View
                style={{
                  flex: 2,
                ...
                <Text style={styles.ttext}>Shortfall</Text>
              </View>
            ...
            {companies.map((x, i) => (
              <View
                ...
                <View
                  ...
                  <Text style={styles.ttext1}>{x.Executed}</Text>
                </View>
                <View
                  style={{
                    flex: 2,
                  ...
                  <Text style={styles.ttext1}>{x.Shortfall}</Text>
                </View>
                <View
                  style={{
                    flex: 1,
